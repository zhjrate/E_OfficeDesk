class MissedPunchApprovalListResponse {
  List<MissedPunchApprovalDetails> details;
  int totalCount;

  MissedPunchApprovalListResponse({this.details, this.totalCount});

  MissedPunchApprovalListResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new MissedPunchApprovalDetails.fromJson(v));
      });
    }
...
class MissedPunchApprovalDetails {
  int rowNum;
  int pkID;
  int employeeID;
  String employeeName;
  ...
  MissedPunchApprovalDetails.fromJson(Map<String, dynamic> json) {
