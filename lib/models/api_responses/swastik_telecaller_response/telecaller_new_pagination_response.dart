class TelecallerNewpaginationResponse {
  List<TelecallerNewpaginationDetails> details;
  int totalCount;

  TelecallerNewpaginationResponse({this.details, this.totalCount});

  TelecallerNewpaginationResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new TelecallerNewpaginationDetails.fromJson(v));
      });
    }
...
class TelecallerNewpaginationDetails {
  int rowNum;
  int pkId;
  String leadID;
  String senderName;
  ...
  TelecallerNewpaginationDetails(
      {this.rowNum,
        this.pkId,
        this.leadID,
        this.senderName,
  ...
  TelecallerNewpaginationDetails.fromJson(Map<String, dynamic> json) {
    ...
    thickness = json['Thickness']==null?0:json['Thickness'];
    quantity = json['Quantity']==null?0:json['Quantity'];
    area = json['Area']==null?0:json['Area'];
    netAmt = json['NetAmt']==null?0:json['NetAmt'];
    refNo = json['RefNo']==null?"":json['RefNo'];
    glassName = json['GlassName']==null?"":json['GlassName'];
    printRate = json['PrintRate']==null?0:json['PrintRate'];
    rate = json['Rate']==null?0:json['Rate'];
    disqualifedRemarks = json['DisqualifedRemarks']==null?"":json['DisqualifedRemarks'];
  }
