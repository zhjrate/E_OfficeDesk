class SearchInstallationResponse {
  List<InstallationListDetails1> details;
  int totalCount;

  SearchInstallationResponse({this.details, this.totalCount});

  SearchInstallationResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new InstallationListDetails1.fromJson(v));
      });
    }
...
class InstallationListDetails1 {
  int rowNum;
  int pkID;
  int customerID;
  String customerName;
  ...
  InstallationListDetails1.fromJson(Map<String, dynamic> json) {
