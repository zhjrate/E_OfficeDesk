class SearchPackingChecklistResponse {
  List<SearchPackingChecklistDetails> details;
  int totalCount;

  SearchPackingChecklistResponse({this.details, this.totalCount});

  SearchPackingChecklistResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new SearchPackingChecklistDetails.fromJson(v));
      });
    }
...
class SearchPackingChecklistDetails {
  int rowNum;
  int pkID;
  int employeeID;
  String employeeName;
  ...
  SearchPackingChecklistDetails.fromJson(Map<String, dynamic> json) {
