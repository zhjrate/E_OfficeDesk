...
class LeaveRequestApprovalListScreen extends BaseStatefulWidget {
  ...
  @override
  _LeaveRequestApprovalListScreenState createState() => _LeaveRequestApprovalListScreenState();
}

class _LeaveRequestApprovalListScreenState extends BaseState<LeaveRequestApprovalListScreen>
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<LeaveRequestScreenBloc, LeaveRequestStates>(
        ...
        listenWhen: (oldState, currentState) {
          ...
          if (currentState is LeaveRequestDeleteCallResponseState || currentState is LeaveApprovalSaveResponseState) {
            return true;
          }
          return false;
          },
...
*/
  ...
  void _onLeaveApprovalSaveCallSucess(LeaveApprovalSaveResponseState state, BuildContext buildContext123) {
