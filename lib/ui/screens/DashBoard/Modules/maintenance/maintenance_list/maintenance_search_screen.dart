...
class SearchMaintenanceScreen extends BaseStatefulWidget {
  ...
  @override
  _SearchMaintenanceScreenState createState() => _SearchMaintenanceScreenState();
}
  ...
  void _onSearchChanged(String value) {
    if (value.trim().length > 2) {
      _CustomerBloc.add(MaintenanceSearchCallEvent(
          MaintenanceSearchRequest(pkID:"",LoginUserID: LoginUserID,SearchKey: value,CompanyID:CompanyID.toString())));
    }
  }

  void _onSearchInquiryListCallSuccess(
      MaintenanceSearchResponseState state) {
