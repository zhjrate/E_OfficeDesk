...
class AddUpdateSalesOrderScreenArguments {
  QuotationDetails editModel;

  AddUpdateSalesOrderScreenArguments(this.editModel);
}

class SalesOrderAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/SalesOrderAddEditScreen';
  final AddUpdateSalesOrderScreenArguments arguments;

  SalesOrderAddEditScreen(this.arguments);

  @override
  _SalesOrderAddEditScreenState createState() =>
      _SalesOrderAddEditScreenState();
}

class _SalesOrderAddEditScreenState extends BaseState<SalesOrderAddEditScreen>
                          ...
                          child: Container(
                            ...
                            child: getCommonButton(baseTheme, () async {
                              ...
                              if (_inquiryProductList.length != 0) {
                                ...
                                showCommonDialogWithSingleOption(context,
                                    "Attlist one product is required to view other charges !",
                                    positiveButtonTitle: "OK");
                              }
                            }, "Other Charges",
                                width: 600, backGroundColor: Color(0xff4d62dc)),
