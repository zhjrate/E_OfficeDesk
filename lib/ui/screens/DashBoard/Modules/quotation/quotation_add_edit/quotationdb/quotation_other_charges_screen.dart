...
class QuotationOtherChargesScreenArguments {
  ...
  QuotationOtherChargesScreenArguments(this.StateCode, this.editModel,this.HeaderDiscFromAddEditScreen);
/* String ChargName1;
  String ChargName2;
  String ChargName3;
  String ChargName4;
...
class _QuotationOtherChargeScreenState
  ...
  TextEditingController _otherChargeExcludeTaxController = TextEditingController();
  ...
  TextEditingController _otherChargeTaxTypeController1 = TextEditingController();
  TextEditingController _otherChargeGSTPerController1 = TextEditingController();
  TextEditingController _otherChargeBeForeGSTController1 = TextEditingController();
  ...
  TextEditingController _otherChargeTaxTypeController2 = TextEditingController();
  TextEditingController _otherChargeGSTPerController2= TextEditingController();
  TextEditingController _otherChargeBeForeGSTController2 = TextEditingController();
  ...
  TextEditingController _otherChargeTaxTypeController3 = TextEditingController();
  TextEditingController _otherChargeGSTPerController3 = TextEditingController();
  TextEditingController _otherChargeBeForeGSTController3 = TextEditingController();
  ...
  TextEditingController _otherChargeTaxTypeController4 = TextEditingController();
  TextEditingController _otherChargeGSTPerController4 = TextEditingController();
  TextEditingController _otherChargeBeForeGSTController4 = TextEditingController();
  ...
  TextEditingController _otherChargeTaxTypeController5 = TextEditingController();
  TextEditingController _otherChargeGSTPerController5 = TextEditingController();
  TextEditingController _otherChargeBeForeGSTController5 = TextEditingController();
  ...
  void initState() {
    ...
    _inquiryBloc.add(QuotationOtherChargeCallEvent(CompanyID.toString(),QuotationOtherChargesListRequest(pkID: "")));
    ...
    _HeaderDiscFromAddEditScreen = widget.arguments.HeaderDiscFromAddEditScreen==null?"":widget.arguments.HeaderDiscFromAddEditScreen;
    ...
    if (_isForUpdate) {
      ...
      _headerDiscountController.text = _editModel.discountAmt.toStringAsFixed(2);
...
*/
  ...
  Widget buildBody(BuildContext context) {
    return WillPopScope(
      ...
      child: Column(
        children: [
          getCommonAppBar(context, baseTheme, "Quotation Charges",showBack: true,showHome: false,onTapOfBack: (){
            ...
            child: SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(children: [
                  ...
                  },ISExpanded==true ? "Other Charges - ":"Other Charges + ",backGroundColor: Color(0xff4d62dc),height: 40),

                 /* Container(
                    margin: EdgeInsets.all(10),
                      child: Text("~~~~~~Other Charges~~~~~~",style: TextStyle(color: colorPrimary),)),*/

                  ISExpanded==true? Column(
                    children: [
                      SizedBox(
                        height: 10,
                      ),
                      Row(children: [
                        Expanded(flex: 2, child: Text("  Charge Type",style: TextStyle(color: colorPrimary,fontSize: 15))),
                        Expanded(flex: 1, child: Text("  Amount",style: TextStyle(color: colorPrimary,fontSize: 15)))
                      ]),
                      Row(children: [
                        Expanded(flex: 2, child:   OtherChargeDropDown1("Other Charge 1",
                            enable1: false,
                            ...
                            Custom_values1: arr_ALL_Name_ID_For_ProjectList1),),
                        Expanded(flex: 1, child: OtherAmount1())
                      ]),
                      Row(children: [
                        Expanded(flex: 2, child:   OtherChargeDropDown2("Other Charge 1",
                            enable1: false,
                            title: "Other Charge 1",
                            hintTextvalue: "Select Other Charge",
                            icon: Icon(Icons.arrow_drop_down),
                            ...
                            Custom_values1: arr_ALL_Name_ID_For_ProjectList2),),
                        Expanded(flex: 1, child: OtherAmount2())
                      ]),
                      Row(children: [
                        Expanded(flex: 2, child:   OtherChargeDropDown3("Other Charge 1",
                            enable1: false,
                            title: "Other Charge 1",
                            hintTextvalue: "Select Other Charge",
                            icon: Icon(Icons.arrow_drop_down),
                            ...
                            Custom_values1: arr_ALL_Name_ID_For_ProjectList3),),
                        Expanded(flex: 1, child: OtherAmount3())
                      ]),
                      Row(children: [
                        Expanded(flex: 2, child:   OtherChargeDropDown4("Other Charge 1",
                            enable1: false,
                            title: "Other Charge 1",
                            hintTextvalue: "Select Other Charge",
                            icon: Icon(Icons.arrow_drop_down),
                            ...
                            Custom_values1: arr_ALL_Name_ID_For_ProjectList4),),
                        Expanded(flex: 1, child: OtherAmount4())
                      ]),
                      Row(children: [
                        Expanded(flex: 2, child:   OtherChargeDropDown5("Other Charge 1",
                            enable1: false,
                            title: "Other Charge 1",
                            hintTextvalue: "Select Other Charge",
                            icon: Icon(Icons.arrow_drop_down),
                            ...
                            Custom_values1: arr_ALL_Name_ID_For_ProjectList5),),
  ...
  void _onOtherChargeListResponse(QuotationOtherChargeListResponseState state) {
    ...
    if (state.quotationOtherChargesListResponse.details.length != 0) {
      ...
      for (var i = 0; i < state.quotationOtherChargesListResponse.details.length; i++)
      {
        print("InquiryStatus : " + state.quotationOtherChargesListResponse.details[i].chargeName);
        ALL_Name_ID all_name_id = ALL_Name_ID();
        all_name_id.Name = state.quotationOtherChargesListResponse.details[i].chargeName;
        all_name_id.pkID = state.quotationOtherChargesListResponse.details[i].pkId;
        all_name_id.Taxtype = state.quotationOtherChargesListResponse.details[i].taxType.toString();
        all_name_id.TaxRate = state.quotationOtherChargesListResponse.details[i].gSTPer.toString();
        all_name_id.isChecked = state.quotationOtherChargesListResponse.details[i].beforeGST;
        ...
        if(_otherChargeIDController1.text==state.quotationOtherChargesListResponse.details[i].pkId.toString())
        {
          _otherChargeIDController1.text = state.quotationOtherChargesListResponse.details[i].pkId.toString();

          _otherChargeNameController1.text  = state.quotationOtherChargesListResponse.details[i].chargeName;

          _otherChargeTaxTypeController1.text = state.quotationOtherChargesListResponse.details[i].taxType.toString();
          _otherChargeGSTPerController1.text = state.quotationOtherChargesListResponse.details[i].gSTPer.toString();
          _otherChargeBeForeGSTController1.text = state.quotationOtherChargesListResponse.details[i].beforeGST.toString();
        }


          if(_otherChargeIDController2.text==state.quotationOtherChargesListResponse.details[i].pkId.toString())
        {
          _otherChargeIDController2.text = state.quotationOtherChargesListResponse.details[i].pkId.toString();

          _otherChargeNameController2.text  = state.quotationOtherChargesListResponse.details[i].chargeName;

          _otherChargeTaxTypeController2.text = state.quotationOtherChargesListResponse.details[i].taxType.toString();
          _otherChargeGSTPerController2.text = state.quotationOtherChargesListResponse.details[i].gSTPer.toString();
          _otherChargeBeForeGSTController2.text = state.quotationOtherChargesListResponse.details[i].beforeGST.toString();
        }


        else  if(_otherChargeIDController3.text==state.quotationOtherChargesListResponse.details[i].pkId.toString())
        {
          _otherChargeIDController3.text = state.quotationOtherChargesListResponse.details[i].pkId.toString();

          _otherChargeNameController3.text  = state.quotationOtherChargesListResponse.details[i].chargeName;

          _otherChargeTaxTypeController3.text = state.quotationOtherChargesListResponse.details[i].taxType.toString();
          _otherChargeGSTPerController3.text = state.quotationOtherChargesListResponse.details[i].gSTPer.toString();
          _otherChargeBeForeGSTController3.text = state.quotationOtherChargesListResponse.details[i].beforeGST.toString();
        }

        else  if(_otherChargeIDController4.text==state.quotationOtherChargesListResponse.details[i].pkId.toString())
        {
          _otherChargeIDController4.text = state.quotationOtherChargesListResponse.details[i].pkId.toString();

          _otherChargeNameController4.text  = state.quotationOtherChargesListResponse.details[i].chargeName;

          _otherChargeTaxTypeController4.text = state.quotationOtherChargesListResponse.details[i].taxType.toString();
          _otherChargeGSTPerController4.text = state.quotationOtherChargesListResponse.details[i].gSTPer.toString();
          _otherChargeBeForeGSTController4.text = state.quotationOtherChargesListResponse.details[i].beforeGST.toString();
        }

        else  if(_otherChargeIDController5.text==state.quotationOtherChargesListResponse.details[i].pkId.toString())
        {
          _otherChargeIDController5.text = state.quotationOtherChargesListResponse.details[i].pkId.toString();

          _otherChargeNameController5.text  = state.quotationOtherChargesListResponse.details[i].chargeName;

          _otherChargeTaxTypeController5.text = state.quotationOtherChargesListResponse.details[i].taxType.toString();
          _otherChargeGSTPerController5.text = state.quotationOtherChargesListResponse.details[i].gSTPer.toString();
          _otherChargeBeForeGSTController5.text = state.quotationOtherChargesListResponse.details[i].beforeGST.toString();
        }
      }
...
*/
  ...
  void _onTapOfAdd() async  {
    ...
    double ChargeAmt2 = double.parse(_otherAmount2.text==null?0.00:_otherAmount2.text);
    double ChargeAmt3 = double.parse(_otherAmount3.text==null?0.00:_otherAmount3.text);
    double ChargeAmt4 = double.parse(_otherAmount4.text==null?0.00:_otherAmount4.text);
    double ChargeAmt5 = double.parse(_otherAmount5.text==null?0.00:_otherAmount5.text);

    double TotalOtherAmnt = ChargeAmt1 + ChargeAmt2 + ChargeAmt3 + ChargeAmt4 + ChargeAmt5;



    print("BeforGSTAmnt" +"ChargeAmnt1 : "+_otherAmount1.text.toString()+"ChargeAmnt2 : "+_otherAmount2.text.toString()+ " ChargeBasicAmnt1 : " + InclusiveBeforeGstAmnt1.toStringAsFixed(2) + " ChargeBasicAmnt2 : " + InclusiveBeforeGstAmnt2.toStringAsFixed(2) + " ChargeGstAmnt1 : "  + InclusiveBeforeGstAmnt_Minus1.toStringAsFixed(2) +" ChargeGstAmnt2 : "  + InclusiveBeforeGstAmnt_Minus2.toStringAsFixed(2) );
  //  print("AfterGSTAmnt" + " AfterGSTAmnt1 : " + AfterInclusiveBeforeGstAmnt1.toStringAsFixed(2) + " AfterGSTAmnt2 : " + AfterInclusiveBeforeGstAmnt2.toStringAsFixed(2)  );
    print("AfterGSTAmnt" +"ChargeAmnt1 : "+_otherAmount1.text.toString()+"ChargeAmnt2 : "+_otherAmount2.text.toString()+ " ChargeBasicAmnt1 : " + AfterInclusiveBeforeGstAmnt1.toStringAsFixed(2) + " ChargeBasicAmnt2 : " + AfterInclusiveBeforeGstAmnt2.toStringAsFixed(2) + " ChargeGstAmnt1 : "  + "0.00" +" ChargeGstAmnt2 : "  + "0.00" );
    print("ExclusiveBeforeGst" + " BeforeGST_AMNT1 : " + ExclusiveBeforeGStAmnt1.toStringAsFixed(2) + " GSTMinus1 : " + ExclusiveBeforeGStAmnt_Minus1.toStringAsFixed(2) +
        " BeforeGST_AMNT2 : "+ ExclusiveBeforeGStAmnt2.toStringAsFixed(2) + " GSTMinus2 : " + ExclusiveBeforeGStAmnt_Minus2.toStringAsFixed(2)

    );

    print("ExclusiveAfterGst" + " AfterGST_AMNT1 : " + ExclusiveAfterGstAmnt1.toStringAsFixed(2) + " AfterGST_AMNT2 : "+ ExclusiveAfterGstAmnt2.toStringAsFixed(2));
    ...
    UpdateAfterHeaderDiscount();
      ...
      print(" GetBasicAmount " + " BasicTotal : " + Tot_BasicAmount.toStringAsFixed(2));


        Tot_otherChargeWithTax = (InclusiveBeforeGstAmnt1) +(ExclusiveBeforeGStAmnt1)+(InclusiveBeforeGstAmnt2)+(ExclusiveBeforeGStAmnt2)+(InclusiveBeforeGstAmnt3)+(ExclusiveBeforeGStAmnt3)+(InclusiveBeforeGstAmnt4)+(ExclusiveBeforeGStAmnt4)+(InclusiveBeforeGstAmnt5)+(ExclusiveBeforeGStAmnt5); //+ (ChargeAmt3 - devide3) + (ChargeAmt4 - devide4) + (ChargeAmt5 - devide5);
        Tot_GSTAmt = Tot_GSTAmt + InclusiveBeforeGstAmnt_Minus1+ExclusiveBeforeGStAmnt_Minus1+InclusiveBeforeGstAmnt_Minus2+ExclusiveBeforeGStAmnt_Minus2+InclusiveBeforeGstAmnt_Minus3+ExclusiveBeforeGStAmnt_Minus3+InclusiveBeforeGstAmnt_Minus4+ExclusiveBeforeGStAmnt_Minus4+InclusiveBeforeGstAmnt_Minus5+ExclusiveBeforeGStAmnt_Minus5;
        Tot_otherChargeExcludeTax = ;
    ...
    double MinusHeaderDiscamnt = Tot_NetAmnt-HeaderDisAmnt;
        _netAmountController.text = MinusHeaderDiscamnt.toStringAsFixed(2); //Tot_BasicAmount.toStringAsFixed(2) + Tot_otherChargeWithTax.toStringAsFixed(2) + Tot_GSTAmt.toStringAsFixed(2) + Tot_otherChargeExcludeTax.toStringAsFixed(2);
    ...
    String ChargeName1 = _otherChargeNameController1.text==null ?"":_otherChargeNameController1.text;
    String ChargeID1 = _otherChargeIDController1.text == null?"":_otherChargeIDController1.text;
    String TaxtType1 = _otherChargeTaxTypeController1.text == null?"":_otherChargeTaxTypeController1.text;
    String TaxRate1 = _otherChargeGSTPerController1.text == null?"":_otherChargeGSTPerController1.text;
    String BeforGST1 = _otherChargeBeForeGSTController1.text == null?"":_otherChargeBeForeGSTController1.text;

    String ChargeName2 = _otherChargeNameController2.text==null ?"":_otherChargeNameController2.text;
    String ChargeID2 = _otherChargeIDController2.text == null?"":_otherChargeIDController2.text;
    String TaxtType2 = _otherChargeTaxTypeController2.text == null?"":_otherChargeTaxTypeController2.text;
    String TaxRate2= _otherChargeGSTPerController2.text == null?"":_otherChargeGSTPerController2.text;
    String BeforGST2 = _otherChargeBeForeGSTController2.text == null?"":_otherChargeBeForeGSTController2.text;

    String ChargeName3 = _otherChargeNameController3.text==null ?"":_otherChargeNameController3.text;
    String ChargeID3 = _otherChargeIDController3.text == null?"":_otherChargeIDController3.text;
    String TaxtType3 = _otherChargeTaxTypeController3.text == null?"":_otherChargeTaxTypeController3.text;
    String TaxRate3 = _otherChargeGSTPerController3.text == null?"":_otherChargeGSTPerController3.text;
    String BeforGST3 = _otherChargeBeForeGSTController3.text == null?"":_otherChargeBeForeGSTController3.text;

    String ChargeName4 = _otherChargeNameController4.text==null ?"":_otherChargeNameController4.text;
    String ChargeID4 = _otherChargeIDController4.text == null?"":_otherChargeIDController4.text;
    String TaxtType4 = _otherChargeTaxTypeController4.text == null?"":_otherChargeTaxTypeController4.text;
    String TaxRate4 = _otherChargeGSTPerController4.text == null?"":_otherChargeGSTPerController4.text;
    String BeforGST4 = _otherChargeBeForeGSTController4.text == null?"":_otherChargeBeForeGSTController4.text;


    String ChargeName5 = _otherChargeNameController5.text==null ?"":_otherChargeNameController5.text;
    String ChargeID5 = _otherChargeIDController5.text == null?"":_otherChargeIDController5.text;
    String TaxtType5 = _otherChargeTaxTypeController5.text == null?"":_otherChargeTaxTypeController5.text;
    String TaxRate5 = _otherChargeGSTPerController5.text == null?"":_otherChargeGSTPerController5.text;
    String BeforGST5 = _otherChargeBeForeGSTController5.text == null?"":_otherChargeBeForeGSTController5.text;
...
print("GetFields"+
    " Charge1 : " + ChargeName1 + " ID1 : " + ChargeID1 + " TaxType1 : " + TaxtType1 + " TaxRate1 : " + TaxRate1 + "BeforGST1" + BeforGST1 +  " OtherAmount :" + ChargeAmount1 +
    " Charge2 : " + ChargeName2 + " ID2 : " + ChargeID2 + " TaxType2 : " + TaxtType2 + " TaxRate2 : " + TaxRate2 + "BeforGST2" + BeforGST2 +  " OtherAmount :" + ChargeAmount2 +
    " Charge3 : " + ChargeName3 + " ID3 : " + ChargeID3 + " TaxType3 : " + TaxtType3 + " TaxRate3 : " + TaxRate3 + "BeforGST3" + BeforGST3 +  " OtherAmount :" + ChargeAmount3 +
    " Charge4 : " + ChargeName4 + " ID4 : " + ChargeID4 + " TaxType4 : " + TaxtType4 + " TaxRate4 : " + TaxRate4 + "BeforGST4" + BeforGST4 +  " OtherAmount :" + ChargeAmount4 +
    " Charge5 : " + ChargeName5 + " ID5 : " + ChargeID5 + " TaxType5 : " + TaxtType5 + " TaxRate5 : " + TaxRate5 + "BeforGST5" + BeforGST5 +  " OtherAmount :" + ChargeAmount5
) ;
...
*/
    ...
    print("DFDFDFDF"+ " TotalBasicAmt : " + Tot_BasicAmount.toStringAsFixed(2) + " Tot_otherChargeWithTax : "  +Tot_otherChargeWithTax.toStringAsFixed(2) + " Tot_GSTAmt : " + Tot_GSTAmt.toStringAsFixed(2) +
        " Tot_otherChargeExcludeTax : " + Tot_otherChargeExcludeTax.toStringAsFixed(2) + " Tot_NetAmt : " + Tot_NetAmt.toStringAsFixed(2) );
...
*/
    ...
    if(_inquiryProductList.length!=0)
      {
        for(int i=0;i<_inquiryProductList.length;i++)
          {
            Tot_BasicAmount =Tot_BasicAmount + _inquiryProductList[i].Amount;
            Tot_otherChargeWithTax = 0.00;///Before Gst
            Tot_GSTAmt = Tot_GSTAmt + _inquiryProductList[i].TaxAmount;
            Tot_otherChargeExcludeTax = 0.00;///AFTER gst
            Tot_NetAmt = Tot_NetAmt + _inquiryProductList[i].NetAmount;
          }
  ...
  /* List<QT_OtherChargeTable> arrTemp = await OfflineDbHelper.getInstance().getQuotationOtherCharge();
   ...
   print("ChargeID" + _otherChargeIDController1.text);
    qt_otherChargeTable.ChargeID1 =int.parse(_otherChargeIDController1.text.toString());//==null?0:_otherChargeIDController1.text.toString());
    qt_otherChargeTable.ChargeID2 =int.parse(_otherChargeIDController2.text.toString());//==null?0:_otherChargeIDController2.text.toString());
    qt_otherChargeTable.ChargeID3 =int.parse(_otherChargeIDController3.text.toString());//==null?0:_otherChargeIDController3.text.toString());
    qt_otherChargeTable.ChargeID4 =int.parse(_otherChargeIDController4.text.toString());//==null?0:_otherChargeIDController4.text.toString());
    qt_otherChargeTable.ChargeID5 =int.parse(_otherChargeIDController5.text.toString());//==null?0:_otherChargeIDController5.text.toString());
    qt_otherChargeTable.Headerdiscount=0.00;
    qt_otherChargeTable.Tot_BasicAmt = double.parse(_basicAmountController.text==null?0.00:_basicAmountController.text);
    qt_otherChargeTable.OtherChargeWithTaxamt = double.parse(_otherChargeWithTaxController.text==null?0.00:_otherChargeWithTaxController.text);
    qt_otherChargeTable.Tot_GstAmt = double.parse(_totalGstController.text==null?0.00:_totalGstController.text);
    qt_otherChargeTable.OtherChargeExcludeTaxamt = double.parse(_otherChargeExcludeTaxController.text==null?0.00:_otherChargeExcludeTaxController.text);
    qt_otherChargeTable.Tot_NetAmount = double.parse(_netAmountController.text==null?0.00:_netAmountController.text);
    qt_otherChargeTable.ChargeAmt1 = double.parse(_otherAmount1.text==null?0.00:_otherAmount1.text);
    qt_otherChargeTable.ChargeAmt2 = double.parse(_otherAmount2.text==null?0.00:_otherAmount2.text);
    qt_otherChargeTable.ChargeAmt3 = double.parse(_otherAmount3.text==null?0.00:_otherAmount3.text);
    qt_otherChargeTable.ChargeAmt4 = double.parse(_otherAmount4.text==null?0.00:_otherAmount4.text);
    qt_otherChargeTable.ChargeAmt5 = double.parse(_otherAmount5.text==null?0.00:_otherAmount5.text);
    ...
    print("hhfdh"+ " ChargeID1 : "+qt_otherChargeTable.ChargeID1.toString()+

        " ChargeID2 : "+qt_otherChargeTable.ChargeID2.toString()+
        " ChargeID3 : "+qt_otherChargeTable.ChargeID3.toString()+
        " ChargeID4 : "+qt_otherChargeTable.ChargeID4.toString()+
        " ChargeID5 : "+qt_otherChargeTable.ChargeID5.toString()
    );
...
void FetchDetailsOfOtherCharges() async {
    List<QT_OtherChargeTable> temp = await OfflineDbHelper.getInstance().getQuotationOtherCharge();
  ...
  void UpdateAfterHeaderDiscount() async {
    ...
    for(int i=0;i<_inquiryProductList.length;i++)
    {
      print("_inquiryProductList[i].NetAmount234" + " Tot_NetAmt : "+ _inquiryProductList[i].NetAmount.toString());
    ...
    HeaderDisAmnt = double.parse(_headerDiscountController.text==null?0.00:_headerDiscountController.text);
    ...
    for(int i=0;i<_inquiryProductList.length;i++)
    {
      ...
      if(_inquiryProductList[i].TaxType==1)
        {
          ExclusiveItemWiseHeaderDisAmnt = (_inquiryProductList[i].NetAmount * HeaderDisAmnt)/tot_amnt_net;
          ExclusiveItemWiseAmount =_inquiryProductList[i].Quantity * _inquiryProductList[i].NetRate;
          ExclusiveNetAmntAfterHeaderDisAmnt = ExclusiveItemWiseAmount-ExclusiveItemWiseHeaderDisAmnt;
          ExclusiveItemWiseTaxAmnt = (ExclusiveNetAmntAfterHeaderDisAmnt * _inquiryProductList[i].TaxRate)/100;
        ...
        {
          InclusiveItemWiseHeaderDisAmnt =  (_inquiryProductList[i].NetAmount * HeaderDisAmnt)/tot_amnt_net;
          InclusiveItemWiseAmount =_inquiryProductList[i].Quantity * _inquiryProductList[i].NetRate;
          ...
          InclusiveItemWiseTaxAmnt = (InclusiveNetAmntAfterHeaderDisAmnt * _inquiryProductList[i].TaxRate)/InclusiveTaxPluse100;
     ...
     print("testExclusive" + " Total ExcBasic : "+ExTotalBasic.toStringAsFixed(2) + "Total ExGSTAmnt : " + ExTotalGSTamt.toStringAsFixed(2) + "Total ExNetAmnt "  +ExTotalNetAmnt.toStringAsFixed(2) );
     print("testExclusive" + " Total ExcBasic : "+InTotalBasic.toStringAsFixed(2) + "Total ExGSTAmnt : " + InTotalGSTamt.toStringAsFixed(2) + "Total ExNetAmnt "  +InTotalNetAmnt.toStringAsFixed(2) );
